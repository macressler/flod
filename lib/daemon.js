        ...
        config: {
            ...
            handler: function (req) {
                ...
                self.server.stdout.on('data', function (data) {
                    ...
                    self.debug('[server]:', data.toString()); // TODO: find a better place to log this than self.debug
                })
                
                self.server.once('exit', function (err) {
                ...
                self.server.on('message', function (msg) {
                    ...
                    switch(msg.action) {
                        ...
                        case 'started':
                            ...
                            self.benchStats.info.nodeVersion = process.versions.node;
