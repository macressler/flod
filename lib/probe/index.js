...
Probe.prototype._instrument = function () {
    ...
    hooks[this.meta.server][matchKey].start(this.server, this.send, opsData);
    
    this.server.__flodStop = hooks[this.meta.server][matchKey].stop;
    
    return hooks[this.meta.server][matchKey].hook(this.server, this.send);
};
...
Probe.prototype.onMessage = function (msg) {
    ...
    switch (msg.action) {
        ...
        case 'exit':
            ...
            //     });
            // });
            this.server.__flodStop(this.server);
            break;
        default: 
