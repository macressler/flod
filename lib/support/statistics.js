...
Statistics.prototype.register = function (query) {
    ...
    var interval = this.options['--metricInterval'] || this._defaultOptions['--metricInterval'];
    
    this.debug("pollMetrics set to run every", interval);
    this.metricsTimer = setInterval(this.bind(this.pollMetrics, this), interval);
...
Statistics.prototype.backupToFile = function (contents) {
    ...
    var backupFilename = path.join(this.options.rootPath || __dirname, this.options['--output'], this.backupFilename());
...
Statistics.prototype.cleanLogs = function () {
    ...
    var dir = path.join(this.options.rootPath || __dirname, this.options['--output']);
